...
- Разпознаване на ключови думи от фактури

NLP - Natural language processor
- Извличане на ключови думи от имейл-сделка

LLM models, AI agents, etc.
- автоматизиране на задачи; консултация за подход при сблъсък с даден таск
...
# Feedforward мрежи и техните ограничения
...
#### Ограничения при применение за изображения
- Огромен брой параметри → медленo обучение
- Губят се локални пространствени структури (ръбове, текстури)
...
# Защо CNN за геопространствени данни
