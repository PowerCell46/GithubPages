...
- автоматизиране на задачи; консултация за подход при работа по даден тикет/задача
...
.center[
  <img src="./images/HumansVsAi.png" alt="CNN"
       style="max-width:70%; max-height:60vh; width:auto; height:auto; object-fit:contain; display:block; margin:0 auto;">
]
