...
# Защо ИНН са от интерес в геопространствения анализ?
...
- Огромен брой параметри → <span style="color:rgb(255, 0, 0)">медленобучение</span>
- Губят се локални пространствени структури (например ръбове, текстури)
...
#### Ключови концепции
- **Локални рецептивни полета:** Всеки неврон „вижда“ само малък **прозорец** от изображението (например 3×3 пиксела), вместо да обработва целия вход наведнъж.
...
- **Decoder част:** операции като upsampling или transposed convolutions възстановяват пространствената разделителна способност
  ...
  - Проблем: декодерът сам по себе си "видя" ниско ниво информация, детайлите се губят
